...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (is_array($result)) {
            ...
            $success_message = "トピックが正常に更新されました (ID: $result)";
        }
    }
}
?>
...
<body>
    <div class="p-4 mx-12 max-w-6xl min-w-80 mx-auto">
        ...
        <main class="bg-gray-100 p-4 mt-4">
            <h2 class="border-b-2 mb-2 py-2 text-lg">トピックス更新</h2>
            <form action="topics-upd.php" method="POST" class="space-y-3">
                <fieldset>
                    <dl>
                    ...
                    <dl class="py-2">
                        ...
                        <dd class="ml-64">
                            <div class="mt-2 flex items-center gap-2">
                                <label class="">
                                    <input <?= $category == "お知らせ" ? 'checked' : '' ?> type="radio" name="category" value="お知らせ" class="h-4 w-4 text-gray-600 border-gray-300 accent-gray-800">
                                    <span class="ml-2 text-gray-700">お知らせ</span>
                                </label>
                                <label class="">
                                    <input <?= $category == "ニュース" ? 'checked' : '' ?> type="radio" name="category" value="ニュース" class="h-4 w-4 text-gray-600 border-gray-300 accent-gray-800">
