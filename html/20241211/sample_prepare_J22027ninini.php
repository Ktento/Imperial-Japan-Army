<body>
<form action="sample_prepare_j22027.php" method="post">
...
while($result = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    print("<td><a href='sample_update_prepare_j22027.php?seito_no={$result['seito_no']}&seito_name={$result['seito_name']}
    &seito_furigana={$result['seito_furigana']}'><p>編集</p></a></td>");
    print("<td><a href='sample_delete_prepare_j22027.php?seito_no={$result['seito_no']}&seito_name={$result['seito_name']}
