...
while($result = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    print("<td><a href='sample_update_prepare_j23029 (2).php?seito_no=". $result['seito_no']."&seito_name=".$result['seito_name']."&seito_furigana=".$result['seito_furigana']." 'target ='_blank'>編集</a></td>");
    print("</tr>");
    $i++;
}
print("</tr>");
