    ...
    <div class="bg-gray-100 py-5 px-6 mb-1 flex relative">
        ...
        <div class="w-3/4 flex justify-between items-start pr-4">
            ...
            <div class="flex space-x-2">
                <a class="p-1 text-xs border border-gray-300 hover:bg-gray-200" href="topics-res-upd.php?i=<?= $comment_id ?>&t=<?= $title ?>&c=<?= $category ?>&a=<?= $target ?>">編集</a>
                <a class="p-1 text-xs border border-red-300 text-red-600 hover:bg-red-200" href="topics-res-del.php?i=<?= $comment_id ?>&t=<?= $title ?>&c=<?= $category ?>&a=<?= $target ?>">削除</a>
            </div>
        </div>
